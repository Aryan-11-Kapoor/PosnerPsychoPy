...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aryan\\OneDrive\\Desktop\\posner\\posner_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    target = visual.ImageStim(
        win=win,
        name='target', 
        image='pospix/bullseye.png', mask=None, anchor='center',
        ori=0.0, pos=[0,0], size=(0.3, 0.3),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    trials = data.TrialHandler(nReps=2.0, method='random', 
        ...
        trialList=data.importConditions('posner.xlsx'),
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if resp.status == NOT_STARTED and t >= 0.7-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.addData('resp.started', t)
                # update status
                resp.status = STARTED
